...
@section('css')
    <link rel="stylesheet" href="{{ voyager_asset('css/settings-index.css') }}">
...
@section('content')
    ...
    <div class="page-content settings container-fluid">
                                    ...
                                    @elseif($setting->type == "image" || $setting->type == "file")
                                        @if(isset( $setting->value ) && !empty( $setting->value ) && Storage::disk(config('voyager.storage.disk'))->exists($setting->value))
                                            <div class="img_settings_container">
                                                ...
                                                <img class="settings-blade-img-1" src="{{ Storage::disk(config('voyager.storage.disk'))->url($setting->value) }}" >
                                            </div>
        ...
        <div class="settings-blade-c-both"></div>

        @can('add', Voyager::model('Setting'))
        <div class="settings-blade-panel-1 panel" >
...
@section('javascript')
    ...
    <iframe id="form_target" name="form_target" class="settings-blade-d-none" ></iframe>
    <form id="my_form" action="{{ route('voyager.upload') }}" target="form_target" method="POST" enctype="multipart/form-data" class="settings-blade-form">
        {{ csrf_field() }}
