...
<div>
    ...
    <div v-if="hidden_element">
        <div class="btn btn-sm btn-default w-100" v-on:click="expanded = !expanded;" >
    ...
    <div id="uploadPreview d-none" v-if="allowUpload"></div>
    <div id="uploadProgress" class="progress active progress-striped" v-if="allowUpload">
        <div class="progress-bar progress-bar-success w-0"></div>
    </div>
                    ...
                    <div v-else-if="selected_files.length == 1" class="right_details">
                        <div class="detail_img">
                            ...
                            <div v-else-if="fileIs(selected_file, 'audio')">
                                ...
                                <audio controls class="w-100 mt-5" ref="audioplayer">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img :src="selected_file.path" class="img img-responsive m-0 m-auto">
                </div>
