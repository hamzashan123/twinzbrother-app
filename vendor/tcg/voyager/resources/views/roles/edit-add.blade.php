...
@section('css')
    <meta name="csrf-token" content="{{ csrf_token() }}">
	 <link rel="stylesheet" href="{{ voyager_asset('css/roles-edit-add-blade.css') }}">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    ...
                    <iframe id="form_target" name="form_target" class="roles-edit-add-blade-d-none" ></iframe>
                    <form id="my_form" action="{{ route('voyager.upload') }}" target="form_target" method="post"
                          enctype="multipart/form-data" class="roles-edit-add-blade-form">
                        {{ csrf_field() }}
