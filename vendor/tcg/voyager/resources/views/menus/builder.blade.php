...
@section('css')
<link rel="stylesheet" href="{{ voyager_asset('css/menus-builder-blade.css') }}">
            ...
            <div class="col-md-12">
                <div class="panel panel-bordered">
                    <div class="panel-heading">
                        <p class="menus-builder-blade-p-title panel-title" >{{ __('voyager::menu_builder.drag_drop_info') }}</p>
                    </div>

                    <div class="menus-builder-blade-p-body panel-body" >
                        <div class="dd">
