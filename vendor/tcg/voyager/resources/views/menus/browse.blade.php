...
@section('css')
<link rel="stylesheet" href="{{ voyager_asset('css/menus-builder-browse-blade.css') }}">
                        ...
                        <table id="dataTable" class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($row->type == 'image')
                                            <img class="menus-builder-browse-blade-img-1" src="@if( strpos($data->{$row->field}, 'http://') === false && strpos($data->{$row->field}, 'https://') === false){{ Voyager::image( $data->{$row->field} ) }}@else{{ $data->{$row->field} }}@endif" >
                                        @else
                                            {{ $data->{$row->field} }}
                                        @endif
                                    </td>
