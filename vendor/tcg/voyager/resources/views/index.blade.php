...
@section('css')
<link rel="stylesheet" href="{{ voyager_asset('css/index-blade.css') }}">
...
@section('javascript')
    ...
    @if(isset($google_analytics_client_id) && !empty($google_analytics_client_id))
		...
		<script src="{{ voyager_asset('js/chartjs.min.js') }}"></script>
		<script src="{{ voyager_asset('js/moment.min.js') }}"></script>
