...
@section('css')
<link rel="stylesheet" href="{{ voyager_asset('css/tools-database-index-blade.css') }}">
                ...
                <table class="table table-striped database-tables">
                    <thead>
                        <tr>
                            ...
                            <th class="tools-database-index-th-1" colspan="2">{{ __('voyager::database.table_actions') }}</th>
                        </tr>
                    </thead>
                    ...
                    <tr>
                        ...
                        <td class="actions">
                            ...
                            <a href="{{ route('voyager.database.edit', $table->prefix.$table->name) }}"
                               class="tools-database-a-1 btn btn-sm btn-primary pull-right" >
                               <i class="voyager-edit"></i> {{ __('voyager::generic.edit') }}
                            </a>
                            <a href="{{ route('voyager.database.show', $table->prefix.$table->name) }}"
                               data-name="{{ $table->name }}"
                               class="tools-database-a-1 btn btn-sm btn-warning pull-right desctable" >
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="#" id="delete_table_form" method="POST">
                        ...
                        <button type="button" class="btn btn-outline pull-right tools-database-btn-1" 
    ...
    <div class="modal modal-info fade" tabindex="-1" id="table_info" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body tools-database-mod-body-1" >
