...
@section('css')
<link rel="stylesheet" href="{{ voyager_asset('css/tools-bread-index-blade.css') }}">
                ...
                <table class="table table-striped database-tables">
                    <thead>
                        <tr>
                            ...
                            <th class="tools-bread-index-th-1">{{ __('voyager::bread.bread_crud_actions') }}</th>
                        </tr>
                    </thead>
                    ...
                    <tr>
                        <td>
                            <p class="name">
                                ...
                                <i class="voyager-data tools-bread-index-i-1"
                                   ></i>
                            </p>
                        </td>
                        ...
                        <td class="actions text-right">
                            @if($table->dataTypeId)
                                <a href="{{ route('voyager.' . $table->slug . '.index') }}"
                                   class="btn btn-warning btn-sm browse_bread mr-0" >
    ...
    <div class="modal modal-info fade" tabindex="-1" id="table_info" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body tools-bread-index-modal-1" >
